...
const Registration = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(buttonRef.current, {
      boxShadow:
        "0 0 30px rgba(160, 105, 55, 0.7), 0 0 50px rgba(160, 105, 55, 0.4)",
      repeat: -1,
      yoyo: true,
      duration: 1.5,
      ease: "sine.inOut",
      ...
      <div className="container">
        ...
        <div className="registration-content" ref={contentRef}>
          <div className="registration-details">
            ...
            <p>
              Ready to test your programming skills? Register now for BUCC Bit
              Battles and compete with the best coders at BRAC University!
            </p>
            ...
            <div className="registration-info-container">
              <div className="eligibility-info">
                ...
                <ul>
                  <li>
                    All currently enrolled undergraduate students of BRAC
                    University
                  </li>
              ...
              <div className="important-dates">
                ...
                <ul>
                  ...
                  <li>
                    <span>Onsite Final Round:</span> 18th July, 2025
                  </li>
                </ul>
              </div>
            </div>
